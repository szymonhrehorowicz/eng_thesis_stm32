...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, FAN_ON_Pin|LED_COIL_Pin|LED_FAN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED_POWER_Pin|LED_ERROR_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = FAN_ON_Pin|LED_COIL_Pin|LED_FAN_Pin;
  ...
  GPIO_InitStruct.Pin = LED_POWER_Pin|LED_ERROR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
